...
public class DialogLoadBackup extends DialogPreference{
	
	public DialogLoadBackup(Context context, AttributeSet attrs){
		super(context, attrs);
		setDialogLayoutResource(R.layout.dialog_backup);
	}
	public DialogLoadBackup(Context context, AttributeSet attrs, int defTheme){
